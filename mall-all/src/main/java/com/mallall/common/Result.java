...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> createBySuccess(T data){
        return new Result<T>(StatusCode.SUCCESS.getCode(),data);
    }

    public static <T> Result<T> createBySuccess(String msg,T data){
        return new Result<T>(StatusCode.SUCCESS.getCode(),msg,data);
    }


    public static <T> Result<T> createByError(){
        return new Result<T>(StatusCode.ERROR.getCode(),StatusCode.ERROR.getDesc());
    }
